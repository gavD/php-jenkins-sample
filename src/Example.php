<?php
class Example {
    public function isAGoodClass() {
        return false;
    }

    public function thisMethodIsHeckOfLongAndThatIsACodeSmell()

  {

        $cant= $wont  = $dont = 'stop';

        $mikeD->comeRockTheSureShot();
        ...
        $lyrics = "Intergalactic Planetary Planetary Intergalactic Another Dimension
